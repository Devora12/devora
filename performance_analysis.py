...
def get_commit_data(repo_slug):
    """Fetch commit data for the specified repository"""
...
2. **Time Efficiency**:  
   ...
   - If the developer took significantly longer than expected (e.g., 2 weeks for 2 days of work), note it as a concern and prioritize this when given user performance.  
...
if __name__ == "__main__":
    # Only ask for repository name
    REPO_SLUG = input("Enter the repository slug/name to analyze: ")
    
    # Fetch commit data
    commit_data = get_commit_data(REPO_SLUG)
